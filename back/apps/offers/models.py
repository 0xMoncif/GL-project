...
class Offer(models.Model):
    ...
    company = models.ForeignKey(
        "profiles.CompanyProfile", on_delete=models.CASCADE, related_name="offers"
    )
    ...
    domain = models.ManyToManyField(
        "catalog.Domain", through="offers.RequiredDomain", blank=True
    )
    specialty = models.ManyToManyField(
        "catalog.Specialty", through="offers.RequiredSpecialty", blank=True
    )
    required_skills = models.ManyToManyField(
        "catalog.Skill", through="offers.RequiredSkill", blank=True
    )
    institutions = models.ManyToManyField(
        "catalog.Institution", through="offers.RequiredInstitution", blank=True
    )
...
class RequiredSkill(models.Model):
    ...
    skill = models.ForeignKey(
        "catalog.Skill", on_delete=models.CASCADE, related_name="skills"
    )
...
class RequiredInstitution(models.Model):
    ...
    institution = models.ForeignKey(
        "catalog.Institution", on_delete=models.CASCADE, related_name="institutions"
    )
...
class RequiredDomain(models.Model):
    ...
    domain = models.ForeignKey(
        "catalog.Domain", on_delete=models.CASCADE, related_name="domains"
    )
...
class RequiredSpecialty(models.Model):
    ...
    specialty = models.ForeignKey(
        "catalog.Specialty", on_delete=models.CASCADE, related_name="specialties"
    )
